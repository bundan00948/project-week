  ...
  class YandexGamesSDKHandler {
    ...
    async InitializeYSDK() {
      ...
      this.ysdk.features.PluginEngineDataReporterAPI?.report({
        ...
        pluginVersion: '2.7.1b',
      });

      console.log('%c YandexGamesSDK for Construct 3 v2.7.1b ', 'background: #14151f; color: #fb923c');
